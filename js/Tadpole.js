var Tadpole = function() {
	...
	this.update = function(mouse, tid) {
	...
	this.onclick = function(e) {
		if(e.ctrlKey && e.which == 1) {
			if(isAuthorized() && tadpole.hover) {
				window.open("http://weibo.com/" + tadpole.name.substring(1));
                return true;
			}
		}
		else if(e.which == 2) {
	...
	this.draw = function(context) {
		...
		}else if(tadpole.sex == 2){
			context.fillStyle = 'rgba(226,219,226,'+opacity+')';
		}else if(tadpole.sex == 3){
			context.fillStyle = 'rgba(255,226,0,'+opacity+')';
		}else if(tadpole.sex == 4){
			context.fillStyle = 'rgba(0,226,0,'+opacity+')';
		}else if(tadpole.sex == 5){
			context.fillStyle = 'rgba(139,0,255,'+opacity+')';
		}else if(tadpole.sex == 6){
